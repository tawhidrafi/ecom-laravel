                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto"
                                            src="{{ asset('assets/upload/product') . '/' . $product->image }}" width="674"
                                            height="674" alt="" />
                                        <a data-fancybox="gallery"
                                            href="{{ asset('assets/upload/product') . '/' . $product->image }}"
                                    ...
                                    @foreach ($product->images as $img)
                                        <div class="swiper-slide product-single__image-item">
                                            <img loading="lazy" class="h-auto"
                                                src="{{ asset('uploads/products/gallery') . '/' . $img }}" width="674"
                                                height="674" alt="" />
                                            <a data-fancybox="gallery"
                                                href="{{ asset('uploads/products/gallery') . '/' . $img }}"
                                                data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <use href="#icon_zoom" />
                        ...
                        <div class="product-single__thumbnail">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto"
                                            src="{{ asset('assets/upload/product') . '/' . $product->image }}" width="104"
                                            height="104" alt="" />
                                    </div>
                                    @foreach ($product->images as $img)
                                        <div class="swiper-slide product-single__image-item">
                                            <img loading="lazy" class="h-auto"
                                                src="{{ asset('uploads/products/gallery') . '/' . $img }}" width="104"
                                                height="104" alt="" />
                                        </div>
                                    @endforeach
                                </div>
                            ...
                            <div class="swiper-slide product-card">
                                <div class="pc__img-wrapper">
                                    <a href="{{ route('shop.show', $product->slug) }}">
                                        <img loading="lazy" src="{{ asset('assets/upload/product') . '/' . $product->image }}"
                                            width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                                        @foreach ($product->images as $img)
                                            <img loading="lazy" src="{{ asset('uploads/products/gallery') . '/' . $img }}"
